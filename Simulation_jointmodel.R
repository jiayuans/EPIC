...
model { 
  ...
  inits1 <- dump.format(list(c0=-4, c=c(0.1,0.1,0.1,0.1), u.tau=1, cp1=7, cp2.temp=7.4,
                             b0=-4.5, b=0.25, a=1.8, w.tau=1, ga=0.25,
                             .RNG.name="base::Super-Duper", .RNG.seed=1))
  inits2 <- dump.format(list(c0=-4.1, c=c(0.1,0.1,0.1,0.1)+0.01, u.tau=1, cp1=7.1, cp2.temp=7.5,
                             b0=-4.51, b=0.26, a=1.81, w.tau=1, ga=0.26,
                             .RNG.name="base::Super-Duper", .RNG.seed=2))
