...
write.csv(result_df, paste0("mixJM.newresult4.",num,".csv"))
save(res, file=paste0("mixJM.newres4.",num,".RData"))

res_jm <- res$mcmc
vars<-mcmc.list(res_jm[[1]][,c(1:16)],res_jm[[2]][,c(1:16)])
pdf(file = paste0("mixJM.newtraceplot4.",num,".pdf"),   # The directory you want to save the file in
