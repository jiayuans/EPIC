...
#############################################################
X <- as.matrix(read.csv(list.files(pattern="mixJM.X_newdata5.")))
Y <- as.matrix(read.csv(list.files(pattern="mixJM.Y_newdata5.")))
simdat.pe00 <- as.data.frame(read.csv(list.files(pattern="mixJM.rec_newdata5.")))
#############################################################
