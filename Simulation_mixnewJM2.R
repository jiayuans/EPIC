...
write.csv(result_df, paste0("mixJM.newresult2.",num,".csv"))
save(res, file=paste0("mixJM.newres2.",num,".RData"))

res_jm <- res$mcmc
vars<-mcmc.list(res_jm[[1]][,c(1:16)],res_jm[[2]][,c(1:16)])
pdf(file = paste0("mixJM.newtraceplot2.",num,".pdf"),   # The directory you want to save the file in
