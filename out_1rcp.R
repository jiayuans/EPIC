...
load("/Users/Shared/Windows/UCHealth/RA/Project/EPIC-CF/Analysis_Jiayuan/EPIC_Sim_Results/JM1rcp_050525_ok/res_1rcp.105.RData")
load("/Users/Shared/Windows/UCHealth/RA/Project/EPIC-CF/Analysis_Jiayuan/EPIC_Sim_Results/1RCP_1003/res_1rcp.1.RData")
...
cbind(true, as.numeric(c(est[2:15])), round(bias,2),round(mse,2),round(cp,2))
