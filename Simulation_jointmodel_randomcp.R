...
model { 
  ...
  ##initial Values
  inits1 <- dump.format(list(c0=-2, c=c(0.2,0.4,-0.2,-0.1), u.tau=1, cp1.mu=17, cp1.tau=49, 
                             b0=-3.4, b=0.2, a=1.7, w.tau=1, ga=0.85, ga1=-0.03, ga2=-0.006,
                             .RNG.name="base::Super-Duper", .RNG.seed=1))
  inits2 <- dump.format(list(c0=-2.1, c=c(0.2,0.4,-0.2,-0.1)+0.01, u.tau=1, cp1.mu=17, cp1.tau=49, 
