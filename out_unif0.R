...
dat <- as.data.frame(cbind(Sim.results,B1,B2,B3,c0,c1,c4,u.sigma2,beta0,beta,alpha,ga,w.sigma2))
bias <- c(sum(dat$B1.mean-dat$B1)/I,sum(dat$B2.mean-dat$B2)/I,sum(dat$B3.mean-dat$B3)/I,sum(dat$c0.mean-dat$c0)/I,
          sum(dat$c1.mean-dat$c1)/I,sum(dat$c4.mean-dat$c4)/I,sum(dat$u.tau.inv.mean-dat$u.sigma2)/I,sum(dat$b0.mean-dat$beta0)/I,sum(dat$b1.mean-dat$beta)/I,
...
mse <- c(sum((dat$B1.mean-dat$B1)^2)/I,sum((dat$B2.mean-dat$B2)^2)/I,sum((dat$B3.mean-dat$B3)^2)/I,sum((dat$c0.mean-dat$c0)^2)/I,
         sum((dat$c1.mean-dat$c1)^2)/I,sum((dat$c4.mean-dat$c4)^2)/I,sum((dat$u.tau.inv.mean-dat$u.sigma2)^2)/I,sum((dat$b0.mean-dat$beta0)^2)/I,sum((dat$b1.mean-dat$beta)^2)/I,
...
dat1 <- as.data.frame( cbind(dat,B1.low,B2.low,B3.low,c0.low,c1.low,c4.low,u.tau.inv.low,
                                 b0.low,b1.low,a.low,ga.low,w.tau.inv.low,B1.high,B2.high,B3.high,c0.high,
                                 c1.high,c4.high,u.tau.inv.high,b0.high,b1.high,a.high,ga.high,w.tau.inv.high))
...
cp <- c(sum(dat1$B1.cp)/I,sum(dat1$B2.cp)/I,sum(dat1$B3.cp)/I,sum(dat1$c0.cp)/I,
        sum(dat1$c1.cp)/I,sum(dat1$c4.cp)/I,sum(dat1$u.tau.inv.cp)/I,
