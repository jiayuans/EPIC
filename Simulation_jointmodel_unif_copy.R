...
model { 
  ...
  ##initial Values
  inits1 <- dump.format(list(c0=-4, c=c(0.3,0.15,0.15,0.1), u.tau=1, cp1=5, cp2=15,
                             b0=-4, b=0.2, a=1.8, w.tau=1, ga=0.3,
                             .RNG.name="base::Super-Duper", .RNG.seed=1))
  inits2 <- dump.format(list(c0=-4.1, c=c(0.3,0.15,0.15,0.1)+0.01, u.tau=1, cp1=5.1, cp2=15.1,
                             b0=-4.1, b=0.2, a=1.81, w.tau=1, ga=0.31,
  ...
  save(res, file=paste0("res.",num,".RData"))
