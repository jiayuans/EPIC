...
model { 
  ...
  ###initial Values
  inits1 <- dump.format(list(c0=-4, c=c(-0.02,0.1,0.1,0.05), u.tau=1,u.tau1=1,u.tau2=1,u.tau3=1,cp1=6.9, cp2.temp=7.5,
                             b0=-4.5, b=0.25, a=1.8, w.tau=1, ga=0.1, ga1=0.15,ga2=1,ga3=1,
                             .RNG.name="base::Super-Duper", .RNG.seed=1))
  inits2 <- dump.format(list(c0=-4.1, c=c(-0.02,0.1,0.1,0.05)+0.01, u.tau=1,u.tau1=1,u.tau2=1,u.tau3=1, cp1=7, cp2.temp=7.5,
                             b0=-4.51, b=0.26, a=1.81, w.tau=1, ga=0.11, ga1=0.16,ga2=1.1,ga3=1.1,
