...
model { 
  ...
  ##initial Values
  inits1 <- dump.format(list(c0=-4, c=c(0.3,0.3,-0.05), u.tau=1, cp1.mu=15, cp1.tau=1, 
                             b0=-4, b=0.2, a=1.8, w.tau=1, ga=0.3, ga1=-0.05,
                             .RNG.name="base::Super-Duper", .RNG.seed=1))
  inits2 <- dump.format(list(c0=-4.1, c=c(0.3,0.3,-0.05)+0.01, u.tau=1, cp1.mu=15.1, cp1.tau=1, 
