...
model { 
  ...
  ##initial Values
  inits1 <- dump.format(list(c0=-2, c=c(0.3,0.3,-0.05), u.tau=0.04, cp1.mu=14.67, cp1.tau=1, 
                             b0=-2, b=0.2, a=1.8, w.tau=0.04, ga=0.2, ga1=-0.05,
                             .RNG.name="base::Super-Duper", .RNG.seed=1))
  inits2 <- dump.format(list(c0=-2.1, c=c(0.3,0.3,-0.05)+0.01, u.tau=0.04, cp1.mu=14.77, cp1.tau=1, 
