...
model { 
  ...
  ##initial Values
  inits1 <- dump.format(list(c0=-4.5, c=c(0.1,0.15,0.1,0.1), u.tau=1, cp1=4.5, cp2=14.5,
                             b0=-4.5, b=0.25, a=1.8, w.tau=1, ga=0.25,
                             .RNG.name="base::Super-Duper", .RNG.seed=1))
  inits2 <- dump.format(list(c0=-4.51, c=c(0.1,0.15,0.1,0.1)+0.01, u.tau=1, cp1=4.6, cp2=14.6,
