...
#############################################################
X <- as.matrix(read.csv(list.files(pattern="mixJM.X_newdata3.")))
Y <- as.matrix(read.csv(list.files(pattern="mixJM.Y_newdata3.")))
simdat.pe00 <- as.data.frame(read.csv(list.files(pattern="mixJM.rec_newdata3.")))
#############################################################
...
###initial Values
inits1 <- dump.format(list(c20=-2.6, delta_c=0.7, c=c(0.3,0.3,-0.05), pi=c(0.4,0.6), pi.r=c(0.5,0.5), u.tau1=6.25,u.tau2=11.11, cp1.mu=14, cp1.tau=1,
                           b20_raw=-1, delta_b=2.5, b=c(0.2,0.3), a1=2.5,a2=0.5, w.tau1=44.44, w.tau2=25, ga10=0.7, ga20=-0.2, ga11=-0.2,
                           .RNG.name="base::Super-Duper", .RNG.seed=1)) 
inits2 <- dump.format(list(c20=-2.5, delta_c=0.6, c=c(0.3,0.3,-0.05)+0.01, pi=c(0.41,0.59), pi.r=c(0.49,0.51), u.tau1=6.25,u.tau2=11.11, cp1.mu=14.1, cp1.tau=0.9,
                           b20_raw=-1.1, delta_b=2.4, b=c(0.2,0.3)+0.1, a1=2.55,a2=0.6, w.tau1=44.44, w.tau2=25, ga10=0.8, ga20=-0.1, ga11=-0.1,
