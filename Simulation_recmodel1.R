...
model { 
  ...
  ###initial Values
  inits1 <- dump.format(list(b0=0.39, b=0.23, a=1.26, ph=.5,
                             .RNG.name="base::Super-Duper", .RNG.seed=1))
  inits2 <- dump.format(list(b0=0.4,b=0.24, a=1.27, ph=.5,
                             .RNG.name="base::Super-Duper", .RNG.seed=2))
  #### Run the model and produce plots
  res <- run.jags(model=modelrancp, burnin=5000, sample=6000, 
